...
<body>
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li>
                                <p><i class="fa fa-phone"></i> Call us 065 970 8735</p>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <!-- START LOGO -->
                        <div class="logo">
                            <a href="index.php"> <img src="images/logo.png" width="40px" height="40px" alt=""> <span class="logoImage">Anthem</span> <span class="CS">CS</span> </a>
                        </div>
                        <!-- END LOGO -->
                    </div>
                    <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="pricing_item">
                        ...
                        <a href="#phplive_btn_1506698159" class="readmore smoth-scroll" onclick="phplive_launch_chat_0()">
                            <span style="color: #0000FF; text-decoration: underline; cursor: pointer;" id="phplive_btn_1506698159" onclick="phplive_launch_chat_0()"></span>GET IT NOW
                        </a> </div>
                </div>
                <!--end item-->
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="our-team-single">
                        ...
                        <div class="caption-text">
                            ...
                            <span>|Back-end Developer|</span> </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="our-team-single">
    ...
    <section id="contactus" class="contactus">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <form id="contact-form" action="send_email.php" class="contact-form" method="POST">
                        <div class="row">
                            ...
                            <div class="col-sm-12"> <span>Phone</span>
                                <div class="form-group"> <i class="fa fa-phone"></i>
                                    <input name="subject" id="subject" class="form-control" required type="number">
                                </div>
                            </div>
                            <div class="col-sm-12"> <span>Message</span>
                                <div class="form-group"> <i class="fa fa-comments-o"></i>
                                    <textarea rows="4" cols="50" name="message" id="message" class="form-control" required type="text"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- / .row -->
    ...
    <!-- <span style="color: #0000FF; text-decoration: underline; cursor: pointer;" id="phplive_btn_1506698159" onclick="phplive_launch_chat_0()"></span> -->
    <script type="text/javascript">

    (function() {
    var phplive_e_1506698159 = document.createElement("script") ;
    phplive_e_1506698159.type = "text/javascript" ;
    phplive_e_1506698159.async = true ;
    phplive_e_1506698159.src = "https://t2.phplivesupport.com/Anthemcs/js/phplive_v2.js.php?v=0|1506698159|2|" ;
    document.getElementById("phplive_btn_1506698159").appendChild( phplive_e_1506698159 ) ;
    })() ;
